...
<li class="sp-menu-item current-item active"><a  href="contactu.html"  >Contact</a></li>-->
														...
														<div class="vm-product-details-container">
	    													...
	    													<div class="spacer-buy-area">
																...
																<div class="addtocart-area">
																	<form method="post"  action="purchdetaction.php?id= <?php echo $row['product_id']; ?>"  name="form1" id="form1" accept-charset="UTF-8" enctype="multipart/form-data">
    ...
    ?>
																		...
																		<div class="form-group">
																			<!--<label>Total no of Item = <?php echo $row['items']; ?></label>--><br>
									<label id="jform_name-lbl" for="jform_name" class="hasPopover required" title="Name" data-content="Enter your name.">
	                               <b> Quantity</b></label>
																		
									<div class="group-control">
										
										<input type="number" name="quantity" id="quantity" class="form-control" placeholder="no. of items" min="1" max="<?php echo $row['items']; ?>">
									</div>
								</div>

								<span id="quantity_error_message" style="color:red" ></span>
								<div class="form-group">
								<label id="jform_name-lbl" for="jform_name" class="hasPopover required" title="Name" data-content="Enter your name.">
	                              <b>  Which packaging type do you prefer</b></label>
																		
									<div class="group-control">
										
										<select name="pack" class="form-control" id="pack"> 
					        													<!--<option value="pack">Packaging Type</option> -->
																			      <?php
								...
								<span id="pack_error_message" style="color:red" ></span>
								<div class="form-group">
								<label id="jform_name-lbl" for="jform_name" class="hasPopover required" title="Name" data-content="Enter your name.">
	                              <b> Which delivery type do you prefer</b></label>
																		
									<div class="group-control">
										
										<select name="deli" class="form-control" id="deli"> 
					        													<!--<option value="deli">Delivery Type</option>--> 
																			      <?php
								...
								<span id="deli_error_message" style="color:red" ></span>
								...
								<!--<div class="form-group">
									<label id="jform_name-lbl" for="jform_name" class="hasPopover required" title="Name" data-content="Enter your name.">
	                                For a period of</label>
																
									<div class="group-control">
										
										<input type="text" name="peri" id="peri" class="form-control" value="">
									</div>
								</div>
								
								<span id="peri_error_message" style="color:red" ></span>-->
								<br>

								<p name="total" id="total" style="color: black;border: none;cursor: pointer;"></p> 
								<h2><b><span id="price_error_message" style="color:#1D75D3;font-weight:bold;size:6" ></span></b></h2>
								<br>
<script >
	...
	var name = $("#deli").val();
            ...
            $("#price_error_message").html("Total: Rs."+total);
