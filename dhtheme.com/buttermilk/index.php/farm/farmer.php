...
jQuery(document).ready( function($) {
			$("#shipto_virtuemart_country_id_field").vm2front("list",{dest : "#shipto_virtuemart_state_id_field",ids : "",prefiks : "shipto_"});
				...
				<ul class="sp-megamenu-parent menu-fade hidden-sm hidden-xs">
					<li class="sp-menu-item"><a  href="../../index-2.php"  >Home</a></li>
					<li class="sp-menu-item sp-has-child"><a  href="../shop.php"  >Shop</a>
<!--
						<div class="sp-dropdown sp-dropdown-main sp-dropdown-mega sp-menu-center" style="width: 600px;left: -300px;">
							<div class="sp-dropdown-inner">
								<div class="row">
									<div class="col-sm-4">
										<ul class="sp-mega-group"><li class="sp-menu-item sp-has-child"><a class="sp-group-title" href="javascript:void(0);"  >Categories</a>
											<ul class="sp-mega-group-child sp-dropdown-items"><li class="sp-menu-item"><a  href="shop/categories/milk.html"  >Milk</a></li><li class="sp-menu-item"><a  href="shop/categories/cheese.html"  >Cheese</a></li><li class="sp-menu-item"><a  href="shop/categories/butter.html"  >Butter</a></li></ul></li></ul>
										</div>
										<div class="col-sm-8">
											<div class="sp-module ">
...
<li class="sp-menu-item"><a  href="about-us.php"  >About us</a></li>
<li class="sp-menu-item"><a  href="blog.php"  >Blog</a></li>-->
<li class="sp-menu-item current-item active"><a  href="farmer.php"  >Farmer</a></li>
</ul>			</div>
		</div></div></div></div></header>
		<section id="sp-page-title"><div class="row"><div id="sp-title" class="col-sm-12 col-md-12"><div class="sp-column "><div class="sp-page-title"><div class="container"><h2>Register here for selling milk to us</h2>
<!--<ol class="breadcrumb">
	<span>You are here: &#160;</span><li><a href="../index-2.html" class="pathway">Home</a></li><li class="active">Contact</li></ol>-->
...
<div id="sp-page-builder" class="sp-page-builder  page-1">
	...
	<div class="page-content">
				...
				<section id="section-id-1504601283914" class="sppb-section " >
					<div class="sppb-row-overlay">
						
					</div>
					<div class="sppb-row-container">
						<div class="sppb-row">
							<div class="sppb-col-md-4" id="column-wrap-id-1504601283915">
								<div id="column-id-1504601283915" class="sppb-column" >
									<div class="sppb-column-addons">
										<div id="sppb-addon-1504603360568" class="clearfix" >
											<div class="sppb-addon sppb-addon-single-image sppb-text-center ">
												<div class="sppb-addon-content">
													<div class="sppb-addon-single-image-container">
														<!--<img class="sppb-img-responsive" src="../../images/Demo/elements/cow.png" alt="Call us" title="">-->
													</div>
												</div>
											</div>
										</div>
							...
							<div class="sppb-col-md-8" id="column-wrap-id-1504603360565">
								<div id="column-id-1504603360565" class="sppb-column" >
									<div class="sppb-column-addons">
										<div id="sppb-addon-1504603360571" class="clearfix" >
											<div class="sppb-addon sppb-addon-ajax-contact ">
												<div class="sppb-ajax-contact-content">



													<form action="farmer_action.php" name="form1" id="form1" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
														<div class="sppb-row">
															<div class="sppb-form-group sppb-col-sm-12">
																Name<br>
																<input type="text" name="name" id="name" placeholder="Name" class="sppb-form-control">
																<span id="name_error_message" style="color:red"></span>
															</div>
															<div class="sppb-form-group sppb-col-sm-12">
															Email<br>
																<input type="email" name="email" id="email" placeholder="Email" class="sppb-form-control">
																<span id="email_error_message" style="color:red"></span>
															</div>

															<div class="sppb-form-group sppb-col-sm-12">
																Phone<br>
																<input type="text" name="phone" id="phone" placeholder="Phone" class="sppb-form-control">
																<span id="phone_error_message" style="color:red"></span>
															</div>
															<div class="sppb-form-group sppb-col-sm-12">
																Approximate fat of your milk<br>
																<input type="text" name="fat" id="fat" placeholder="approximate fat" class="sppb-form-control">
																<span id="fat_error_message" style="color:red"></span>
															</div>
							<!--<div class="sppb-form-group sppb-col-sm-12">
								Upload your adhar card<br>
								<input type="file" name="pic" id="pic">
								<span id="pic_error_message" style="color:red"></span>
							</div>-->
															<div class="sppb-form-group sppb-col-sm-12">
																Upload Adhar
																<input type="file" style="width:100%" name="pic" class="sppb-form-control" id="pic" required />
															...
															<div class="sppb-form-group sppb-col-sm-12">
																Approximate amount of your milk<br>
																<input type="text" name="milk" id="milk" placeholder="approximate amount of milk" class="sppb-form-control">
																<span id="milk_error_message" style="color:red"></span>
															</div>
															<div class="sppb-form-group sppb-col-sm-12">
																Address<br>
																<textarea name="address" rows="5" id="address" placeholder="Address" class="sppb-form-control">
															...
															<div class="sppb-form-group sppb-col-sm-12">
																...
																<select name="places" class="form-control" id="places"> 
													        													<option value="place">Places</option> 
																											      <?php
																											      $que="select * from tb_places where status='1'";
																											  $obj=new db();
																											  $queee=$obj->execute($que);
																											          ...
																											          { 
																											            ...
																											            echo "<option value='" . $rows['place_id'] ."'>" . $rows['place'] ."</option>";
																											          }
																											        }
															...
															<div class="sppb-form-group sppb-col-sm-12">
																Password<br>
																<input type="password" name="CreatePassword" id="CreatePassword" placeholder="CreatePassword" class="sppb-form-control">
																<span id="password_error_message" style="color:red"></span>
															</div>
															<div class="sppb-form-group sppb-col-sm-12">
																Confirm Password<br>
																<input type="password" name="CPassword" id="CPassword" placeholder="ConfirmPassword" class="sppb-form-control">
																<span id="cpassword_error_message" style="color:red"></span>
															</div>
														
						
															<div class="sppb-text-left">
																<input type="submit" name="submit" id="submit" value="Submit" class="sppb-btn sppb-btn-primary sppb-btn-lg sppb-btn-round" style="background: #1D75D3;color: white"> 
															</div>
														</div>
													</form>
