...
//if($lid>0)
//{
  $sel="SELECT tb_reg.fname,tb_reg.lname,tb_reg.phone,tb_product.product,purchasedetails.quantity,purchasedetails.total FROM purchasedetails INNER JOIN tb_login ON purchasedetails.login_id=tb_login.login_id INNER JOIN tb_reg ON tb_login.login_id=tb_reg.login_id WHERE purchasedetails.status=1 ";
  $obj=new db();
