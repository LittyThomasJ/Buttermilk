...
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
    ...
    <script type="text/javascript" language="javascript" src="javascripts/details.js"></script>-->
...
<!-- Virtuemart 2 Ajax Card -->
														<div class="vmCartModule " id="vmCartModule">
															...
															<div class="total_products"><a href="viewcart.php">Go to Cart </a></div>
															<div class="show_cart">
    												...
    												<div class="vm-product-container">
														...
														<div class="vm-product-details-container">
															...
															<div class="sku-container">
																<div class="sku" style="font-size: 15">
																	
																	<strong style="color: red"><?php echo $row['items']; ?></strong>
																	<strong>more left&nbsp</strong>&nbsp
																</div>
															</div>
															<br>
	    													...
	    													<div class="spacer-buy-area">
																...
																<div class="product-price" id="productPrice3" data-vm="product-prices">
																	...
																	<div class="PricesalesPrice vm-display vm-price-value">
																		...
																		<span class="PricesalesPrice">Rs &nbsp<?php echo $row['price']; ?>
				...
				<!--
    																	<div class="addtocart-bar">
	            															...
	            															<label>Quantity </label>
																				...
																				<input type="text" class="quantity-input js-recalculate" name="quantity[]" id="quantity[]" data-errStr="You can buy this product only in multiples of %s pieces!" value="1" init="1" step="1"  />
		...
		<div class="addthis_inline_share_toolbox"></div>-->
					                       ...
					                       value="1" init="1" step="1"  />
																			...
																			<span class="addtocart-button" >
																				<input type="submit" name="addtocart" id="addtocart" class="addtocart-button" value="Buy Now" title="Buy now"  onclick="window.location='purchasedetails.php?id= <?php echo $row['product_id']; ?>';" />


																						</span>  
																						<?php
																						$cartt="SELECT * FROM tb_addcart WHERE product_id=$id && status='0' && login_id=$lid";
	$obj=new db();
	$carttt=$obj->execute($cartt);
	if(mysqli_num_rows($carttt)>0)
   {
   	//echo "<script type='text/javascript'>alert('already added');</script>";
																			...
																			<span class="addtocart-button">
																				...
																				<input type="submit" name="addtocart" id="addtocart" class="addtocart-button" value="Add to Cart" title="Already Added to Cart" />
																				<br>
									                						</span>
									                						<?php
									                					}
	        										...
	        										<div class="product-description" >
														...
														<h4>Ingredients:</h4>
														<p><!--Fresh pasteurised milk from dairy cows left to graze naturally, sea salt.--><?php echo $row['ing']; ?>
					...
					<li>Calories From Fat: 250</li>
														...
														<div class="product-field product-field-type-X">
															...
															<div class="product-field-display">
																<img alt="" src="web_admin/upload/<?php echo $row['picture2']; ?>">
															</div>	
															<div>
																<br>
																<span class="addtocart-button">
									                						<input type="submit" name="rating" id="rating" class="addtocart-button" value="Ratings and Reviews" title="Rating and Reviews"  onclick="window.location='rating.php?id= <?php echo $row['product_id']; ?>';"/>
											...
											<form action="http://dhtheme.com/buttermilk/index.php/cheese?search=true" method="get">
											...
											<li class="item-150"><a href="../milk.html" > Milk</a></li><li class="item-151  current active"><a href="../cheese.html" > Cheese</a></li><li class="item-152"><a href="../butter.html" > Butter</a></li></ul>
											</div></div><div class="sp-module title7"><h3 class="sp-module-title">Login</h3><div class="sp-module-content"><form action="http://dhtheme.com/buttermilk/index.php/cheese/white-cheese-detail" method="post" id="login-form">
												...
												<ul class="form-links">
													<li>
																<a href="../features/joomla-virtuemart/joomla-registration.html">Create an account</a>
															</li>
													<li>
												...
												<input type="hidden" name="return" value="aHR0cDovL2RodGhlbWUuY29tL2J1dHRlcm1pbGsvaW5kZXgucGhwL2NoZWVzZS93aGl0ZS1jaGVlc2UtZGV0YWls" />
