...
<a href="viewcart.php"><div class="total_products" >Go to Cart</div></a>
<a href="viewcart.php"><div class="show_cart">
...
Please wait</noscript>
				...
				<ul class="sp-megamenu-parent menu-fade hidden-sm hidden-xs"><li class="sp-menu-item"><a  href="../index-2u.php"  >Home</a></li><li class="sp-menu-item current-item active"><a  href="userhome.php"  >Shop</a>
...
<div class="product vm-col vm-col-3 vertical-separator">
		<div class="spacer product-container" data-vm="product-container">
			<div class="vm-product-media-container">
					...
					<a title="<?php echo $row['product']; ?>" href="Details.php?id= <?php echo $row['product_id']; ?>">
			...
			<div class="vm-product-rating-container">
				...
				<div class="vm-product-descr-container-1">
					<h2><a href="Details.php?id= <?php echo $row['product_id']; ?>" ><?php echo $row['product']; ?></a></h2>
    ...
    <div class="addtocart-bar">
			...
			<!--<span class="addtocart-button">
				...
				<a href="Details.php?id= <?php echo $row['product_id']; ?>" title="#" class="product-details"><b>View more</b></a>			</div>           
