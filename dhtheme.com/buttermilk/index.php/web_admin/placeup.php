...
//echo $id;
	...
	$sel="SELECT * FROM tb_places where place_id=$id";
	$obj=new db();
...
$row=mysqli_fetch_array($select);
	...
	?>
	<form name="cat" id="cat" action="placeupaction.php?id= <?php echo $row['place_id']; ?>" method="post" class="form-horizontal ">
	<table>
	<tr><td>Places</td>
	<td><input type="text"  name="category" id="category" value="<?php echo $row['place'];?>" class="input-lg"/>
