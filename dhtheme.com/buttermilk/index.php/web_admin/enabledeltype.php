...
//if($lid>0)
//{
	$sel="SELECT * FROM tb_deliverytype WHERE status='0'";
	$obj=new db();
...
<div class="panel-heading" style="background-color:#c4e17f">
	<h1>Enable Delivery Type </h1></div><br>
...
<a href="deliverytypeen.php?id= <?php echo $row['deliverytype_id']; ?>" onclick="return confirm_alert(this);">Enable</a>
<?php
echo "</td>";
