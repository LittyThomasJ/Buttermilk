...
//echo $id;
	...
	$sel="SELECT * FROM tb_deliverytype where deliverytype_id=$id";
	$obj=new db();
...
<div class="panel-heading" style="background-color:#c4e17f">
	<h1>Update Delivery Type </h1></div><br>
...
$row=mysqli_fetch_array($select);
	...
	?>
	<form name="cat" id="cat" action="delitypeup.php?id= <?php echo $row['deliverytype_id']; ?>" method="post" class="form-horizontal ">
	<table>
	<tr><td>Category</td>
	<td><input type="text"  name="category" id="category" value="<?php echo $row['deliverytype'];?>" class="input-lg"/>
