...
//if($lid>0)
//{
	$sel="SELECT * FROM tb_product WHERE status='0'";
	$obj=new db();
...
<a href="enprodact.php?id= <?php echo $row['product_id']; ?>" onclick="return confirm_alert(this);">Enable</a>
<?php
echo "</td>";
