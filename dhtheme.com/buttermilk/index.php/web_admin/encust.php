...
//if($lid>0)
//{
	$sel="SELECT tb_login.email,tb_login.login_id,tb_reg.fname,tb_reg.lname,tb_reg.phone FROM tb_login INNER JOIN tb_reg ON tb_login.login_id=tb_reg.login_id WHERE tb_login.status=0 && tb_login.role='user'";
	$obj=new db();
...
<a href="encustact.php?id= <?php echo $row['login_id']; ?>" onclick="return confirm_alert(this);">Enable</a>
