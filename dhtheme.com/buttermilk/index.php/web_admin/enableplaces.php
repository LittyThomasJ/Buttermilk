...
//if($lid>0)
//{
	$sel="SELECT * FROM tb_places WHERE status='0'";
	$obj=new db();
...
<a href="placeenact.php?id= <?php echo $row['place_id']; ?>" onclick="return confirm_alert(this);">Enable</a>
<?php
echo "</td>";
