...
//if($lid>0)
//{
	$sel="SELECT * FROM tb_package WHERE status='0'";
	$obj=new db();
...
<div class="panel-heading" style="background-color:#c4e17f">
	<h1>Enable Package Type </h1></div><br>
...
<tr>
<th text='blue'>Package</th><th>When</th><th>Action</th>
...
<a href="packageenact.php?id= <?php echo $row['pack_id']; ?>" onclick="return confirm_alert(this);">Enable</a>
<?php
echo "</td>";
