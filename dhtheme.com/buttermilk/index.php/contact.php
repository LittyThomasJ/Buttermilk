...
jQuery(document).ready( function($) {
			$("#shipto_virtuemart_country_id_field").vm2front("list",{dest : "#shipto_virtuemart_state_id_field",ids : "",prefiks : "shipto_"});
				...
				<ul class="sp-megamenu-parent menu-fade hidden-sm hidden-xs"><li class="sp-menu-item"><a  href="../index-2.php"  >Home</a></li><li class="sp-menu-item sp-has-child"><a  href="shop.php"  >Shop</a><div class="sp-dropdown sp-dropdown-main sp-dropdown-mega sp-menu-center" style="width: 600px;left: -300px;"><div class="sp-dropdown-inner"><div class="row"><div class="col-sm-4"><ul class="sp-mega-group"><li class="sp-menu-item sp-has-child"><a class="sp-group-title" href="javascript:void(0);"  >Categories</a><ul class="sp-mega-group-child sp-dropdown-items"><li class="sp-menu-item"><a  href="shop/categories/milk.html"  >Milk</a></li><li class="sp-menu-item"><a  href="shop/categories/cheese.html"  >Cheese</a></li><li class="sp-menu-item"><a  href="shop/categories/butter.html"  >Butter</a></li></ul></li></ul></div><div class="col-sm-8"><div class="sp-module "><div class="sp-module-content">

<div class="custom"  >
	<a href="shop.html"><img src="../images/Demo/elements/categories.png" alt="Milk"></a></div>
</div></div></div></div></div></div></li><li class="sp-menu-item"><a  href="about-us.php"  >About us</a></li><li class="sp-menu-item"><a  href="blog.php"  >Blog</a></li><li class="sp-menu-item current-item active"><a  href="contact.html"  >Contact</a></li></ul>			</div>
...
<div id="sp-page-builder" class="sp-page-builder  page-1">
	...
	<div class="page-content">
				<section id="section-id-1504601283914" class="sppb-section " ><div class="sppb-row-overlay"></div><div class="sppb-row-container"><div class="sppb-row"><div class="sppb-col-md-4" id="column-wrap-id-1504601283915"><div id="column-id-1504601283915" class="sppb-column" ><div class="sppb-column-addons"><div id="sppb-addon-1504603360568" class="clearfix" ><div class="sppb-addon sppb-addon-single-image sppb-text-center "><div class="sppb-addon-content"><div class="sppb-addon-single-image-container"><img class="sppb-img-responsive" src="../images/Demo/elements/cow.png" alt="Call us" title=""></div></div></div></div></div></div></div><div class="sppb-col-md-8" id="column-wrap-id-1504603360565"><div id="column-id-1504603360565" class="sppb-column" ><div class="sppb-column-addons"><div id="sppb-addon-1504603360571" class="clearfix" ><div class="sppb-addon sppb-addon-ajax-contact "><div class="sppb-ajax-contact-content">
					<!--<form class="sppb-ajaxt-contact-form"><div class="sppb-row"><div class="sppb-form-group sppb-col-sm-12"><input type="text" name="name" class="sppb-form-control" placeholder="Name" required></div><div class="sppb-form-group sppb-col-sm-12"><input type="email" name="email" class="sppb-form-control" placeholder="Email" required></div><div class="sppb-form-group sppb-col-sm-12"><input type="text" name="subject" class="sppb-form-control" placeholder="Subject" required></div><div class="sppb-form-group sppb-col-sm-12"><input type="text" name="captcha_question" class="sppb-form-control" placeholder="5 + 7 = ?" required></div><div class="sppb-form-group sppb-col-sm-12"><textarea name="message" rows="5" class="sppb-form-control" placeholder="Message" required></textarea></div></div><input type="hidden" name="recipient" value="ZW1haWxAeW91cmRvbWFpbi5jb20="><input type="hidden" name="from_email" value="aHFAYnR0bWsuY29t"><input type="hidden" name="from_name" value="QnV0dGVyTWlsayBMVEQ="><input type="hidden" name="captcha_answer" value="c20ad4d76fe97759aa27a0c99bff6710"><input type="hidden" name="captcha_type" value="default"><div class="sppb-text-left"><button type="submit" id="btn-1504603360571" class="sppb-btn sppb-btn-primary sppb-btn-lg sppb-btn-round"><i class="fa"></i> Send Message</button></div></form>
