...
Please wait</noscript>
				...
				<ul class="sp-megamenu-parent menu-fade hidden-sm hidden-xs"><li class="sp-menu-item"><a  href="../index-2.php"  >Home</a></li><li class="sp-menu-item current-item active"><a  href="shop.php"  >Shop</a>
...
<!--<li class="sp-menu-item"><a  href="about-us.php"  >About us</a></li><li class="sp-menu-item"><a  href="blog.php"  >Blog</a></li><li class="sp-menu-item"><a  href="contact.php"  >Contact</a> </li> --></ul>			</div>
...
?>
					...
					while($row=mysqli_fetch_array($select))
	{
		...
		<div class="spacer product-container" data-vm="product-container">
			<div class="vm-product-media-container">
					...
					<a title="<?php echo $row['product']; ?>" href="Detailsnot.php?id= <?php echo $row['product_id']; ?>">
			...
			<div class="vm-product-rating-container">
				...
				<div class="vm-product-descr-container-1">
					<h2><a href="Detailsnot.php?id= <?php echo $row['product_id']; ?>" ><?php echo $row['product']; ?></a></h2>
	...
	<span class="price-crossed" ></span><div class="PricesalesPrice vm-display vm-price-value"><span class="vm-price-desc">Sales price: </span><span class="PricesalesPrice">Rs.<?php echo $row['price']; ?></span></div><div class="PricediscountAmount vm-nodisplay"><span class="vm-price-desc">Discount: </span><span class="PricediscountAmount"></span></div><div class="PricetaxAmount vm-nodisplay"><span class="vm-price-desc">Tax amount: </span><span class="PricetaxAmount"></span></div></div>				<div class="clear"></div>
		...
		<form method="post" class="product js-recalculate" action="Detailsnot.php?id= <?php echo $row['product_id']; ?>" autocomplete="off" >
    ...
    <div class="addtocart-bar">
			...
			<span class="addtocart-button">
				...
				<a href="Details.php?id= <?php echo $row['product_id']; ?>" title="#" class="product-details"><b>View more</b></a>			</div>   </span>             <input type="hidden" name="virtuemart_product_id[]" value="3"/>
...
<!--
		...
		<div class="spacer product-container" data-vm="product-container">
			...
			<div class="vm-product-rating-container">
				...
				<div class="vm-product-descr-container-1">
					<h2><a href="#" >Strawberry Yogurt</a></h2>
										<p class="product_s_desc">
    ...
    <div class="addtocart-bar">
			...
			<div class="vm-details-button">
				<a href="#" title="Strawberry Yogurt" class="product-details">Product details</a>			</div>
				</div>
	</div>
    ...
    <div class="addtocart-bar">
			...
			<div class="vm-details-button">
				<a href="#" title="Milk 3,6%" class="product-details">Product details</a>			</div>
				</div>
	</div>
    ...
    <div class="addtocart-bar">
			...
			<div class="vm-details-button">
				<a href="#" title="Banana Yogurt" class="product-details">Product details</a>			</div>
				</div>
	</div>
		...
		<div class="spacer product-container" data-vm="product-container">
			...
			<div class="vm-product-rating-container">
				...
				<div class="vm-product-descr-container-1">
					<h2><a href="#" >Bulgarian Yogurt</a></h2>
										<p class="product_s_desc">
						Best Yoghort...											</p>
							</div>
    ...
    <div class="addtocart-bar">
			...
			<div class="vm-details-button">
				<a href="#" title="Bulgarian Yogurt" class="product-details">Product details</a>			</div>
				</div>
	</div>
		...
		<div class="spacer product-container" data-vm="product-container">
			...
			<div class="vm-product-rating-container">
				...
				<div class="vm-product-descr-container-1">
					<h2><a href="#" >Drinking Yogurt</a></h2>
										<p class="product_s_desc">
						Best Yoghurt ...											</p>
							</div>
    ...
    <div class="addtocart-bar">
			...
			<div class="vm-details-button">
				<a href="#" title="Drinking Yogurt" class="product-details">Product details</a>			</div>
				</div>
	</div>
		...
		<div class="spacer product-container" data-vm="product-container">
			...
			<div class="vm-product-rating-container">
				...
				<div class="vm-product-descr-container-1">
					<h2 class="sppb-social-share-style-solid"><a href="#" >Cheese</a></h2>
										<p class="product_s_desc">
    ...
    <div class="addtocart-bar">
			...
			<div class="vm-details-button">
				<a href="#" title="Emmentaler" class="product-details">Product details</a>			</div>
				</div>
	</div>
		...
		<div class="spacer product-container" data-vm="product-container">
			...
			<div class="vm-product-rating-container">
				...
				<div class="vm-product-descr-container-1">
					<h2><a href="#" >Gouda with Cumin</a></h2>
										<p class="product_s_desc">
						New taste...											</p>
							</div>
    ...
    <div class="addtocart-bar">
			...
			<div class="vm-details-button">
				<a href="#" title="Gouda with Cumin" class="product-details">Product details</a>			</div>
				</div>
	</div>
		...
		<div class="spacer product-container" data-vm="product-container">
			...
			<div class="vm-product-rating-container">
				...
				<div class="vm-product-descr-container-1">
					<h2><a href="#" >Grass-Fed Organic Ghee</a></h2>
										<p class="product_s_desc">
						Ghee ...											</p>
							</div>
    ...
    <div class="addtocart-bar">
			...
			<div class="vm-details-button">
				<a href="#" title="Grass-Fed Organic Ghee" class="product-details">Product details</a>			</div>
				</div>
	</div> -->
	<?php
}
...
<div id="sp-right" class="col-sm-3 col-md-3">
	...
	<div class="sp-column class2">
		...
		<!--<div class="sp-module  title9"><h3 class="sp-module-title">Product Search</h3><div class="sp-module-content">--BEGIN Search Box -->
...
<li class="item-150"><a href="#" > Milk</a></li><li class="item-151"><a href="#" > Cheese</a></li><li class="item-152"><a href="#" > Butter</a></li></ul>
</div></div>-->

<div class="sp-module title7"><h3 class="sp-module-title">Login</h3><div class="sp-module-content"><form action="logaction.php" method="post" id="login-form">
	...
	<div id="form-login-username" class="form-group">
				...
				<input id="Email" type="email" name="Email" class="form-control" tabindex="0" size="18" placeholder="Email" />
			</div>
			</div>
	<div id="form-login-password" class="form-group">
		<div class="controls">
					...
					<input id="Email" type="Password" name="Password" class="form-control" tabindex="0" size="18" placeholder="Password" />
				</div>
					</div>
	</div>
	...
	<div id="form-login-submit" class="form-group">
		<input type="submit" tabindex="0" id="submit" name="submit" class="btn btn-primary" value="Submit" style="background-color: #208bf3;color: white">
	</div>
	...
	<ul class="form-links">
		...
		<li>
			<a href="farm/farmer.php">Sell milk to us</a>
		</li>
		<li>
			<a href="forgot2.php">
