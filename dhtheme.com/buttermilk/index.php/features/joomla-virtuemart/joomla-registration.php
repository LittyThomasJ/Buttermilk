...
<!-- Mirrored from dhtheme.com/buttermilk/index.php/features/joomla-virtuemart/joomla-registration by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Sep 2019 13:54:12 GMT -->
...
.sp-megamenu-parent{font-family:Catamaran, sans-serif; font-size:16px; font-weight:700; }
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"a89392f302fa4882263609b98e7cec3b","system.paths":{"root":"\/buttermilk","base":"\/buttermilk"},"system.keepalive":{"interval":840000,"uri":"\/buttermilk\/index.php\/component\/ajax\/?format=json"},"joomla.jtext":{"JLIB_FORM_FIELD_INVALID":"Invalid field:&#160"}}</script>
	...
	<script src="../../../media/system/js/mootools-core86d6.js?19a092cf799ed6c41792146343f78261" type="text/javascript"></script>
	...
	<script src="../../../media/system/js/punycode86d6.js?19a092cf799ed6c41792146343f78261" type="text/javascript"></script>
	<script src="../../../media/system/js/validate86d6.js?19a092cf799ed6c41792146343f78261" type="text/javascript"></script>
	<!--[if lt IE 9]><script src="/buttermilk/media/system/js/html5fallback.js?19a092cf799ed6c41792146343f78261" type="text/javascript"></script><![endif]-->
...
jQuery(document).ready( function($) {
			$("#shipto_virtuemart_country_id_field").vm2front("list",{dest : "#shipto_virtuemart_state_id_field",ids : "",prefiks : "shipto_"});
				...
				<ul class="sp-megamenu-parent menu-fade hidden-sm hidden-xs"><li class="sp-menu-item"><a  href="../../../index-2.php"  >Home</a></li><li class="sp-menu-item sp-has-child"><a  href="../../shop.php"  >Shop</a>
...
<!--
</li><li class="sp-menu-item"><a  href="../../about-us.php"  >About us</a></li><li class="sp-menu-item"><a  href="../../blog.php"  >Blog</a></li><li class="sp-menu-item"><a  href="../../contact.php"  >Contact</a></li>--></ul>			</div>
...
<h2> Registration</h2>
<!--<ol class="breadcrumb">
	<span>You are here: &#160;</span><li><a href="../../../index-2.html" class="pathway">Home</a></li><li>Features</li><li>Joomla &amp; Virtuemart</li><li class="active">Joomla! Registration</li></ol>-->
...
<div class="row">
	<div class="col-sm-4 col-sm-offset-4">
		<div class="registration">
			...
			<form action="regaction.php" id="create_customer" name="create_customer" accept-charset="UTF-8" method="post"  enctype="multipart/form-data">
									...
									<div class="group-control">
										<input type="text" name="FirstName" id="FirstName"  value="" class="required" size="30"    />
								...
								<span id="name_error_message" style="color:red" ></span>
									...
									<div class="group-control">
										<input type="text" name="LastName" id="LastName"  value="" class="validate-username required" size="30"  />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="group-control">
										<input type="text" name="Phone" class="#" id="Phone" value=""
 										size="30"   />									
 									</div>
								</div>
								...
								<div class="form-group">
 								...
 								size="30"    autocomplete="email" />									</div>
								</div>
										<span id="email_error_message" style="color:red" ></span>																		<div class="form-group">
									...
									<div class="group-control">
										<input type="password" name="CreatePassword" id="CreatePassword" value=""  autocomplete="off" class="validate-password required"   size="30" maxlength="99" />									</div>
								</div>
									...
									<div class="group-control">
										<input type="password" name="CPassword" id="CPassword" value=""  autocomplete="off" class="validate-password required"   size="30" maxlength="99" />									</div>
								</div>
										<span id="cpassword_error_message" style="color:red"></span>											<!--<div class="form-group">
									<label id="jform_usertype-lbl" for="jform_usertypr" class="hasPopover required" title="Usertype" data-content="Usertype.">
									Usertype</label>
				...
				<div class="form-group">
					<input type="submit" id="submit" name="submit" value="Create an account">
...
<span class="offcanvas-menu-toggler collapsed" data-toggle="collapse" data-target="#collapse-menu-161"><i class="open-icon fa fa-angle-down"></i><i class="close-icon fa fa-angle-up"></i></span><ul class="collapse" id="collapse-menu-161"><li class="item-165"><a href="../features/feature-box.html" > Feature Box</a></li><li class="item-169"><a href="../features/buttons.html" > Buttons</a></li><li class="item-171"><a href="../features/accordions-tabs.html" > Accordions &amp; Tabs</a></li><li class="item-172"><a href="../features/progress-bars-pies.html" > Progress Bars &amp; Pies</a></li><li class="item-176"><a href="../features/pricing-tables.html" > Pricing Tables</a></li><li class="item-179"><a href="../features/team-testimonials.html" > Team &amp; Testimonials</a></li></ul></li><li class="item-162  divider deeper parent"><a class="separator ">More Features</a>
<span class="offcanvas-menu-toggler collapsed" data-toggle="collapse" data-target="#collapse-menu-162"><i class="open-icon fa fa-angle-down"></i><i class="close-icon fa fa-angle-up"></i></span><ul class="collapse" id="collapse-menu-162"><li class="item-170"><a href="../more-features/animated-numbers-and-countdown.html" > Animated Numbers &amp; Countdown</a></li><li class="item-149"><a href="../more-features/typography.html" > Typography</a></li><li class="item-156"><a href="../more-features/module-variations.html" > Module Variations</a></li><li class="item-166"><a href="../more-features/module-positions.html" > Module Positions</a></li><li class="item-167"><a href="../../../index114a.html?tmpl=comingsoon" > Coming Soon</a></li><li class="item-168"><a href="../more-features/404-error-page.html" > 404 Error Page</a></li></ul></li><li class="item-163  active divider deeper parent"><a class="separator ">Joomla &amp; Virtuemart</a>
<span class="offcanvas-menu-toggler collapsed" data-toggle="collapse" data-target="#collapse-menu-163"><i class="open-icon fa fa-angle-down"></i><i class="close-icon fa fa-angle-up"></i></span><ul class="collapse" id="collapse-menu-163"><li class="item-164"><a href="single-article.html" > Single Article</a></li><li class="item-173"><a href="../../blog.html" > Category Blog</a></li><li class="item-174  current active"><a href="joomla-registration.html" > Joomla! Registration</a></li><li class="item-175"><a href="search.html" > Search</a></li><li class="item-177"><a href="single-product.html" > Single Product</a></li><li class="item-178"><a href="../../shop/categories/milk.html" > Product Category</a></li></ul></li></ul></li></ul>
</div></div>
                                                    </div> <!-- /.offcanvas-inner -->
                    </div> <!-- /.offcanvas-menu -->
...
<!-- Mirrored from dhtheme.com/buttermilk/index.php/features/joomla-virtuemart/joomla-registration by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Sep 2019 13:54:16 GMT -->
</html>
