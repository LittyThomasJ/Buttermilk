...
Please wait</noscript>
				...
				<ul class="sp-megamenu-parent menu-fade hidden-sm hidden-xs"><li class="sp-menu-item"><a  href="../index-2.php"  >Home</a></li><li class="sp-menu-item sp-has-child current-item active"><a  href="shop.php"  >Shop</a><div class="sp-dropdown sp-dropdown-main sp-dropdown-mega sp-menu-center" style="width: 600px;left: -300px;"><div class="sp-dropdown-inner"><div class="row"><div class="col-sm-4"><ul class="sp-mega-group"><li class="sp-menu-item sp-has-child"><a class="sp-group-title" href="javascript:void(0);"  >Categories</a><ul class="sp-mega-group-child sp-dropdown-items"><li class="sp-menu-item"><a  href="shop/categories/milk.html"  >Milk</a></li><li class="sp-menu-item"><a  href="shop/categories/cheese.html"  >Cheese</a></li><li class="sp-menu-item"><a  href="shop/categories/butter.html"  >Butter</a></li></ul></li></ul></div><div class="col-sm-8"><div class="sp-module "><div class="sp-module-content">

<div class="custom"  >
	<a href="shop.html"><img src="../images/Demo/elements/categories.png" alt="Milk"></a></div>
</div></div></div></div></div></div></li><li class="sp-menu-item"><a  href="about-us.php"  >About us</a></li><li class="sp-menu-item"><a  href="blog.php"  >Blog</a></li><li class="sp-menu-item"><a  href="contact.php"  >Contact</a></li></ul>			</div>
...
Results 1 - 6 of 15<br/><select id="limit" name="limit" class="inputbox" size="1" onchange="window.top.location.href=this.options[this.selectedIndex].value">
	  ...
	  <h4>Featured Products</h4>
		...
		<div class="spacer product-container" data-vm="product-container">
			<div class="vm-product-media-container">
					...
					<a title="White Cheese" href="cheese/white-cheese-detail.html">
						<img src="../images/virtuemart/product/resized/white-cheese_500x500.jpg" alt="white-cheese" class="browseProductImage" />					</a>
			...
			<div class="vm-product-rating-container">
				...
				<div class="vm-product-descr-container-1">
					<h2><a href="cheese/white-cheese-detail.html" >White Cheese</a></h2>
										<p class="product_s_desc">
						Buttermilk is modern cheese ...											</p>
							</div>


						<div class="vm3pr-1"> <div class="product-price" id="productPrice3" data-vm="product-prices">
	<span class="price-crossed" ></span><div class="PricesalesPrice vm-display vm-price-value"><span class="vm-price-desc">Sales price: </span><span class="PricesalesPrice">$12.90</span></div><div class="PricediscountAmount vm-nodisplay"><span class="vm-price-desc">Discount: </span><span class="PricediscountAmount"></span></div><div class="PricetaxAmount vm-nodisplay"><span class="vm-price-desc">Tax amount: </span><span class="PricetaxAmount"></span></div></div>				<div class="clear"></div>
			</div>
    ...
    <div class="addtocart-bar">
			...
			<div class="vm-details-button">
				<a href="cheese/white-cheese-detail.html" title="White Cheese" class="product-details">Product details</a>			</div>
				</div>
	</div>
...
</div></div><div id="sp-right" class="col-sm-3 col-md-3"><div class="sp-column class2"><div class="sp-module  title9"><h3 class="sp-module-title">Product Search</h3><div class="sp-module-content"><!--BEGIN Search Box -->
...
<!-- End Search Box --></div></div><div class="sp-module title8"><h3 class="sp-module-title">Categories</h3><div class="sp-module-content"><ul class="nav menu">
<li class="item-150"><a href="milk.html" > Milk</a></li><li class="item-151"><a href="cheese.html" > Cheese</a></li><li class="item-152"><a href="butter.html" > Butter</a></li></ul>
</div></div><div class="sp-module title7"><h3 class="sp-module-title">Login</h3><div class="sp-module-content"><form action="http://dhtheme.com/buttermilk/index.php/shop" method="post" id="login-form">
	...
	<ul class="form-links">
		<li>
					<a href="features/joomla-virtuemart/joomla-registration.php">Create an account</a>
				</li>
		<li>
			<a href="features/joomla-virtuemart/joomla-registration4488.html?view=remind">
			Forgot your username?</a>
		</li>
		<li>
			<a href="features/joomla-virtuemart/joomla-registration798d.html?view=reset">
	...
	<input type="hidden" name="return" value="aHR0cDovL2RodGhlbWUuY29tL2J1dHRlcm1pbGsvaW5kZXgucGhwL3Nob3A=" />
	<input type="hidden" name="a89392f302fa4882263609b98e7cec3b" value="1" />
	</form>
