...
<li class="sp-menu-item current-item active"><a  href="contactu.html"  >Contact</a></li>-->
    ...
    ?>
									...
									<div class="group-control">
										...
										<input type="number" name="quantity" id="quantity" class="form-control" placeholder="no. of items">
									</div>
								</div>
								...
								<div class="form-group">
								<label id="jform_name-lbl" for="jform_name" class="hasPopover required" title="Name" data-content="Enter your name.">
	                                Which packaging type do u prefer</label>
								...
								<div class="form-group">
								<label id="jform_name-lbl" for="jform_name" class="hasPopover required" title="Name" data-content="Enter your name.">
	                               Which delivery type do u prefer</label>
								...
								<span id="peri_error_message" style="color:red" ></span>-->
									...
									<br>
					<input type="submit" id="submit" name="submit" value="Go" class="addtocart-button">
