...
<li class="sp-menu-item current-item active"><a  href="contactu.html"  >Contact</a></li>-->
																...
																if(mysqli_num_rows($se)>0)
							   									{
							   										$rowss=mysqli_fetch_array($se);
																		...
																		?>
																	<form method="post"  action="puraddraction.php?id= <?php echo $rowss['purchase_id']; ?>"  name="form1" id="form1" accept-charset="UTF-8" enctype="multipart/form-data">
    ...
    ?>
																...
																<!--<label id="price"><b>Total Price = </b><?php echo $rowss['total'] ; ?></label>--><br>
																<br>
																		</div>
							...
							<textarea rows="3" cols="70" name="address" id="address" placeholder="Address" class="form-control"></textarea>
								...
								<div class="form-group">
								<label id="jform_name-lbl" for="jform_name" class="hasPopover required" title="Name" data-content="Enter your name.">
	                               Place in which product to be delivered?</label>
								...
								<span id="payment_error_message" style="color:red" ></span>
									...
									<br>
					<input type="submit" id="submit" name="submit" value="Go" class="addtocart-button" style="color:white;background-color:#1D75D3;border: none;padding: 10px 32px;
  text-align: center;
