														...
														<div class="vm-product-details-container">
															...
															<div class="sku-container">
																<div class="sku" style="font-size: 15">
																	<strong>No of Items Available&nbsp=</strong>&nbsp
	    													...
	    													<div class="spacer-buy-area">
																...
																<div class="product-price" id="productPrice3" data-vm="product-prices">
																	...
																	<div class="PricesalesPrice vm-display vm-price-value">
																		...
																		<span style="color: #2C7BBD"><b>Login to Buy</b></span>
																	</div>
					...
					<li>Calories From Fat: 250</li>
														...
														<div class="product-field product-field-type-X">
															...
															<div>
																<br>
																<!--<span class="addtocart-button">
									                						<input type="submit" name="rating" id="rating" class="addtocart-button" value="Ratings and Reviews" title="Add to Cart"  onclick="window.location='rating.php?id= <?php echo $row['product_id']; ?>';"/>
