...
$id=$_GET['id'];
echo $id;
$sel="SELECT * FROM bank_info where status=1 and name_on_card='customer'";
	$obj=new db();
														...
														<div class="vm-product-details-container">
	    													...
	    													<div class="spacer-buy-area">
																...
																<div class="addtocart-area">
																	...
																	<form method="post"  action="paymentaction.php?id=<?php echo $id;?>"  name="form1" id="form1" accept-charset="UTF-8" enctype="multipart/form-data">
...
name="name" id="name" 
placeholder="name"
value="<?php echo $row['name_on_card']; ?>" 
...
/>
								...
								<div class="form-group">
									...
									<div class="group-control">
										...
										<input type="tel" class="form-control" name="cardNumber" id="cardNumber" placeholder="Valid Card Number"  value="<?php echo $row['card_number']; ?>" />
										
									</div>
								</div>

								<span id="card_error_message" style="color:red" ></span>
...
placeholder="MM / YY"
autocomplete="cc-exp"
required value="<?php echo $row['expiration_date']; ?>" 
/>

								
									</div>
								</div>
								<span id="cardex_error_message" style="color:red" ></span>
...
/>
									...
									<span id="cvv_error_message" style="color:red" ></span>
								</div>
					...
					<input type="submit" id="submit" name="submit" value="Go" class="addtocart-button" style="background-color: ">
